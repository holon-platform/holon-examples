...
This example shows how to setup the same server endpoints and client invocations as the [JAX-RS and PropertyBox example](../propertybox) using __Spring Boot__.
